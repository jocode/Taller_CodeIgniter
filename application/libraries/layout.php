...
/**
    ...
    public $name       = 'Aquí va el nombre de la Aplicación';	
	public $keywords    = 'Palabras claves para que el motor de busqueda lo indexe, para dar información a los motores de búsqueda.';	
	public $descripcion = 'La descripción de la aplicación';
	/**
	 * Constructor
	 *
